module Grape
  module Validations
    class HeadersScope
      ...
      def configure_declared_headers

          @api.namespace_stackable(:declared_headers, @declared_headers)

          @api.route_setting(:declared_headers, []) unless @api.route_setting(:declared_headers)
          @api.route_setting(:declared_headers, @api.namespace_stackable(:declared_headers).flatten)
      end
